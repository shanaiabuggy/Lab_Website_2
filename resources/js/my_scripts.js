...
function loadStatsPage(){
		...
		{//Outer for loop iterates over each row
			homeScore = cell_value = table.rows[row_counter].cells[2].innerHTML;//Read in a cells current value
			oppScore = cell_value = table.rows[row_counter].cells[3].innerHTML;//Read in a cells current value
		...
		wins.innerHTML = win_count;//Update the actual html of the cell
